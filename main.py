...
def main():
	...
	#rdf_graph.load("http://dbpedia.org/page/A._P._J._Abdul_Kalam")
	#rdf_graph.load("http://dbpedia.org/page/Tim_Berners-Lee")
	...
	formatter.format()
	data = "<html><head><link rel='stylesheet' type='text/css' href='style.css'></head><body>" 
